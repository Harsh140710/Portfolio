...
const Agency = () => {
  ...
  return (
    <div>
      <div className="section-1">
        ...
        <div className="relative font-['Personal-font-500']">
          <div className="mt-[55vh]">
            <h1 className="text-[18vw] font-extra bold text-center uppercase leading-[14vw] space-y-3">
              Master
              <br />
          ...
          <div className="pl-[40%] mt-20">
            <p className="text-[2.5vw] font-[Personal-font-300]">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I’m
      ...
      <div className="section-2 h-screen mt-64 font-[Personal-font-300]">
        ...
        <div className="mt-20 pl-30 pr-30 flex items-center justify-around gap-10">
          <h2 className="text-2xl">Our Work_ Born in curiosity, raised by dedication and fed with a steady diet of creativity.</h2>
